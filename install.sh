...
sudo cp ~/.dotfiles/autologin.conf /etc/systemd/system/getty@tty1.service.d/autologin.conf
...
ln -s $HOME/.dotfiles/lambda-mod.zsh-theme $HOME/.oh-my-zsh/themes/lambda-mod.zsh-theme
